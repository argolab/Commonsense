...
class data():
    def __init__(self, path='airdat.csv', drop_zero=True, clean=['bedrooms', 'log_price'], cols=['log_price', 'bathrooms', 'property_type', 'room_type', 'accommodates', 'bedrooms', 'beds', 'amenities', 'review_scores_rating', 'city']):
